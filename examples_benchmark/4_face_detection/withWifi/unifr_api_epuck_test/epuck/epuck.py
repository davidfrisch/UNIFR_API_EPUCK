from ..communication.host_communication import get_available_clients
    ...
    def init_client_communication(self, host_ip='localhost'):
        ...
        while not is_connect:
            try:
                ...
                print(e)
                print(self.get_id() + ' lost connection with host manager messages at initialisation.')
                self.clean_up()
                sys.exit(1)
    ...
    def stay_alive(self):
        ...
        if self.manager:
            try:
                ...
                print(e)
                print(self.get_id() + ' lost connection with host manager messages in stay_alive().')
    ...
    def send_msg(self, msg):
        ...
        if self.manager:
            try:
                ...
                print(e)
                print(self.get_id() + ' lost connection with host manager messages in send_msg.')
    ...
    def has_receive_msg(self):
        ...
        if self.manager:
            try:
                ...
                print(e)
                print(self.get_id() + ' lost connection with host manager messages in has_receive_msg.')
    ...
    def receive_msg(self):
        ...
        if self.manager:
            ...
            try:
                ...
                print(e)
                print(self.get_id() + ' lost connection with host manager messages in receive_msg().')
    ...
    def get_connected_epucks(self):
        ...
        if self.manager:
            try:
                ...
                # must make a copy if we want to acces via key
                current_dict = self.syncdict.copy()
                available_epucks_list = get_available_clients(current_dict['connected'])
                # Check if array is empty
                self.lock.release()
