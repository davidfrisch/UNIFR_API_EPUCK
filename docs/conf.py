...
autodoc_mock_imports = ['PIL','socket','time','sys','smbus2','VL53L0X','subprocess','cv2','threading','math','numpy','os','torch','.models','struct','logging','warning','random','torchvision','copy']
